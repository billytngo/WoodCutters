...
var NonPreemptiveGameWorld = cc.Layer.extend({
    ...
    createGameObjects:function(){
        ...
        sprite.setColor(getColor(jobs[jobId].color));
        ...
        if(this.touchingTime>=this.holdingTimeMax){
            ...
            for(var jobId in jobs){
                if(this.jobSprites[jobId]!=null &&
                    ...
                    this.jobSprites[jobId].setColor(getColor(this.facility.jobs[jobId].color));
        ...
        if(this.selectedJobId!=null){
            ...
            if(selectedMachineId!=null){
                ...
                if(this.selectedMachineId==null){
                    ...
                    this.outlineJobSprite.setColor(getColor(this.facility.jobs[jobId].color));
    ...
    pushJob:function(machineId){
        ...
        jobSprite.setColor(getColor(this.facility.jobs[jobId].color));
    ...
    enableMachine:function(machineId){
        ...
        sprite.setColor(cc.c3b(0, 100, 0));
        sprite.setPosition(center);
        this.addChild(sprite);
    ...
    adjustIndicator:function(){
        ...
        for(var i=0;i<h;i++){
            ...
            sprite.setColor(cc.c3b(0, 180, 0));
